...
static class BuildCommand
{
    ...
    static void PerformBuild()
    {
        ...
        if (buildReport.summary.result != UnityEditor.Build.Reporting.BuildResult.Succeeded)
            Console.WriteLine($"Build Status: {buildReport.summary.result}");
            Console.WriteLine($"Build Duration: {buildReport.summary.totalTime}");
            Console.WriteLine($"Build Warnings: {buildReport.summary.totalWarnings}");
            Console.WriteLine($"Build Errors: {buildReport.summary.totalErrors}");
